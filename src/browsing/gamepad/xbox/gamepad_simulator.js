...
async function run_small_example(timeout=12000){
  ////////////////////////////
  // Start the emulator
  ...
  while (i < 10){
    ...
    simulateBtnPress(button);
    console.log(`Pressed Btn ${button}\n\n`)
    await new Promise(resolve => setTimeout(resolve, 2000));
    simulateBtnUnpress(button);
  ...
  ///////////////////////////////////////////
  // At around the 12 second mark, disconnect
  simulateGamepadDisconnect();
